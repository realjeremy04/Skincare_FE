...
const ArticleCard = ({
  ...
  <div className="flex flex-col w-full text-red-400 max-md:mt-8 items-center">
    <div className="flex flex-col text-xl font-bold leading-tight items-center">
      ...
      />
      <h2 className="mt-2.5 w-[380px] text-start">{title}</h2>
    </div>
...
const articles: ArticleCardProps[] = [
  {
    imageSrc:
      "https://cdn.builder.io/api/v1/image/assets/41aab81e665b459d8a900c6a1ab04494/bec278afebcd0d527e6f0f07bf99dd10fe66dcbbd5ea979643173e90a59851f4?apiKey=41aab81e665b459d8a900c6a1ab04494&",
  ...
  {
    imageSrc:
      "https://cdn.builder.io/api/v1/image/assets/41aab81e665b459d8a900c6a1ab04494/59cab9845aec16a471f8cd024681613af2507d0b582cc877e83c4a6068dff12c?apiKey=41aab81e665b459d8a900c6a1ab04494&",
    title: "Top 5 anti-aging ingredients you need to know",
    date: "November 3, 2024",
  },
  {
    imageSrc:
      "https://cdn.builder.io/api/v1/image/assets/41aab81e665b459d8a900c6a1ab04494/56ac21d483ba3ae4e26c33a3c3484e00ba9284f74a293d459b5a511ff5d5ba84?apiKey=41aab81e665b459d8a900c6a1ab04494&",
